...
本手册复现实验文档 [cost-ablation.md](cost-ablation.md) 的 cost function 消融矩阵，但将控制协议从 `virtual_asap` 改为真实墙钟 100 Hz 的 `threaded_asap`。
...
原始 virtual-asap 实验的背景、cost 定义和旧结果见 [cost-ablation.md](cost-ablation.md)。
