...
- `docs/architecture/project-structure.md`：说明仓库结构、路径约定、dynamics 与 MPC 的职责划分。
- `docs/architecture/mpc-pseudocode.md`：把当前 MPC 主线翻译成伪代码，解释 closed-loop receding horizon、planner、CEM、cost 和脚本关系。
- `docs/Note.md`：记录 2026-07-03 的历史问题和 cost function 理解笔记；其中的 cost 表述不作为当前实现规范。
- `docs/archive/project-completion-status.md`：本文档，整理当前项目已经完成的内容。
