...
本 README 第 1-16 节中的 dynamics 数据采集、训练、open-loop 评估命令都应该从 `dynamics_modeling/` 目录运行：
...
- 相对路径会按项目根目录 `dynamics_modeling/` 解析。
...
python scripts/eval_dynamics.py \
  ...
  --horizons 1,5,10,20,50,100,200 \
  --teacher_forcing \
  --save_dir outputs/figures/transformer_teacher_forcing
...
```text
/home/xinlei/Data/RL_Projects/NN-MPC_RobotArm/dynamics_modeling
```
