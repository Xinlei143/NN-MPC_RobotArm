...
def parse_args() -> argparse.Namespace:
    ...
    parser.set_defaults(model_type="gru", history_len=16, horizon=25, num_samples=128, cem_iters=2, replan_interval_steps=5, multirate_mode="virtual_asap", episode_len=500)
